class Permissions extends React.Component {
    ...
    updatePermissions() {
        let url = `/api/set-permissions?default-permissions=${this.state.defaultPermissions}&permissions=${this.getPermissionsAsString()}`; // if (this.state.users.length === 1) {
        //     url = url + `?userEmail=${this.state.users[0]}`;
        // }
    ...
    render() {
        ...
        return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("form", null, /*#__PURE__*/React.createElement("div", {
        ...
        }, this.state.saving && /*#__PURE__*/React.createElement("div", {
            className: alertColor,
            role: "alert"
        }, alertText), /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
            className: "row justify-content-center vertical-margin question-snapshot"
        }, /*#__PURE__*/React.createElement("div", {
            className: "col col-md-6 text-center"
            ...
            return /*#__PURE__*/React.createElement(React.Fragment, {
                ...
                className: className
            }, permission), /*#__PURE__*/React.createElement("input", {
        ...
        }))), canEditUsers && /*#__PURE__*/React.createElement("div", {
            className: "row justify-content-center vertical-margin question-snapshot"
        }, /*#__PURE__*/React.createElement("div", {
            className: "col col-md-6"
        }, /*#__PURE__*/React.createElement("label", null, "Enter the emails here, they can be separated by spaces or commas"), /*#__PURE__*/React.createElement("textarea", {
            className: "form-control",
            placeholder: "Enter emails here",
            onChange: onEnterEmail
        }))), canEditDefault && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("label", {
            className: "checkbox-dropdown-label"
        }, "Update Default Permissions"), /*#__PURE__*/React.createElement("input", {
...
root.render( /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Navbar, null), /*#__PURE__*/React.createElement(Permissions, null)));